        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm text-muted-foreground">
                <svg className="h-4.5 w-4.5 text-secondary fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-start gap-3 text-sm text-muted-foreground">
                <MapPin className="h-4.5 w-4.5 text-secondary mt-1 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Head Office</strong><br />
                  Chaibasa, Jharkhand,<br />
                  India - 833201
                </span>
              </li>
            </ul>
